    ...
    <div className="nine columns main-col">
      <div className="row item">
        <div className="twelve columns">
          ...
          <p>
            TNDS is tailored to and driven by each student’s professional goals
            and personal needs. It’s a place to work on both personal and client
            projects, with the support and guidance of industry experts, a
            network of mentors, a team of facilitators and your fellow students.
          </p>
        </div>
      </div>
      ...
      <div className="row item">
        <div className="twelve columns">
          ...
          <p>
            besides of learning a lot with the great content they provide I
            develop my self-discipline in order to pursue a new career change.
          </p>
        </div>
      </div>
    </div>
