      ...
      <div className="nine columns main-col">
        ...
        <p>
          ...
          <p>
            ...
            own and client projects, with the support and guidance of industry
            experts, a network of mentors, a team of facilitators and your
            fellow students. Throw the school we had the opportunity to make
            client projects, some during school time others on ower free time,
            which allow us to prepare for a professional environment.
          </p>
          <p>
            During this time, I've been learning Design skills that complement
            me as a Frontend developer, especially on the problem-solving
            approach and having a better understanding of the collaborative work
